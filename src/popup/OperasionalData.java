 ...
 * @author BadikIrwan
 */
public class OperasionalData extends javax.swing.JDialog {
    
    private Operasional aThis;
    private String tgl;
     ...
     * @param aThis
     */
    public OperasionalData(java.awt.Frame parent, boolean modal, Operasional aThis) {
        super(parent, modal);
        this.aThis = aThis;
        initComponents();
        LoadPekerjaan();
    ...
    private OperasionalData(JFrame jFrame, boolean b) {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            if(btnSimpan.getText().equals("Simpan")) {
                String query = "INSERT INTO tbl_operasional(id,pekerjaan,minggu_ke,tanggal,pengguna,uraian,volume,satuan,harga,jumlah)"
                        + "VALUES(null,'"+pekerjaan+"','"+minggu+"','"+tgl+"','"+pengguna+"','"+uraian+"','"+volume+"','"+satuan+"','"+harga+"','"+jumlah+"')";
                st.executeUpdate(query);
                JOptionPane.showMessageDialog(null, "Data Berhasil disimpan", "Pesan", JOptionPane.INFORMATION_MESSAGE);
            } else {
                String query ="UPDATE tbl_operasional SET pekerjaan='"+pekerjaan+"',minggu_ke='"+minggu+"',tanggal='"+tgl+"',pengguna='"+pengguna+"',"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OperasionalData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OperasionalData dialog = new OperasionalData(new javax.swing.JFrame(), true);
