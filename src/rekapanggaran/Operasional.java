 ...
 * @author BadikIrwan
 */
public class Operasional extends javax.swing.JPanel {

    private Component rootPane;

    /**
     * Creates new form Operasional
     */
    public Operasional() {
        initComponents();
        Pekerjaan();
    ...
    private void cbKegiatanItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbKegiatanItemStateChanged
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM tbl_operasional WHERE pekerjaan='"+cbKegiatan.getSelectedItem()+"'");
            if(rs.next() == true) {
                do {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        try {
            if(row == -1) {
                ...
                Connection con = Koneksi.connect();
                Statement st = con.createStatement();
                st.executeUpdate("DELETE FROM tbl_operasional WHERE id='"+tabel.getModel().getValueAt(row, 0)+"'");
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        ...
        try {
            if(row == -1) {
                ...
                Connection con = Koneksi.connect();
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT * FROM tbl_operasional WHERE id='"+tabel.getModel().getValueAt(row, 0)+"'");
                if(rs.next()) {
                    OperasionalData admin = new OperasionalData(null, true, this);
                    ...
                    admin.txtPengguna.setText(rs.getString("pengguna"));
