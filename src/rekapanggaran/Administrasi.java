...
public class Administrasi extends javax.swing.JPanel {
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        AdministrasiData admin = new AdministrasiData(null, true, this);
        admin.show();
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        ...
        try {
            if(row == -1) {
                ...
                ResultSet rs = st.executeQuery("SELECT * FROM tbl_administrasi WHERE id='"+tabel.getModel().getValueAt(row, 0)+"'");
                if(rs.next()) {
                    AdministrasiData admin = new AdministrasiData(null, true, this);
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        try {
            if(row == -1) {
                ...
                Connection con = Koneksi.connect();
                Statement st = con.createStatement();
                st.executeUpdate("DELETE FROM tbl_administrasi WHERE id='"+tabel.getModel().getValueAt(row, 0)+"'");
    ...
    private void cbKegiatanItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbKegiatanItemStateChanged
        ...
        try {
            Connection con = Koneksi.connect();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT * FROM tbl_administrasi WHERE pekerjaan='"+cbKegiatan.getSelectedItem()+"'");
            if(rs.next() == true) {
                do {
